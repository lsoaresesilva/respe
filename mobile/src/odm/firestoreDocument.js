...
export class FireStoreDocument {
    ...
    validate(document) {
        ...
        if (document != null || document != undefined) {
            if (document.payload != undefined && (typeof document.payload.data == "function" || (document.payload.doc != undefined && typeof document.payload.doc.data == "function"))) {
                return true;
