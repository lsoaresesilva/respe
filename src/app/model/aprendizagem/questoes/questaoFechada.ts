...
export default class QuestaoFechada extends QuestaoBase {
  ...
  isRespostaCorreta(resposta: RespostaBase): boolean {
    const respostaConvertida = resposta as RespostaQuestaoFechada;
  ...
  validar() {
    if (
      ...
      (!Array.isArray(this.conceitos) ||
      this.conceitos.length === 0) ||
