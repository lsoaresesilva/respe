...
export default class TypeError extends ErroCompilacao {
  ...
  getMensagem() {
    return (
      'Há um problema no seu código na linha ' +
      this.linha +
      '. As possíveis causas, podem ser: 1) você tentou realizar uma operação matemática em duas variáveis de tipos diferentes'
    );
  }
}
