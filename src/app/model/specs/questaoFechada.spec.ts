...
describe("Testes de questão fechada", ()=>{
    ...
    let questao = new QuestaoFechada(null, "bla", "bla bla bla\r'''python\rx = 2\r'''\rble ble ble", 1, 1, null, "");
    ...
    it("Deve indicar que o texto não possui código", ()=>{
        ...
        let questaoSemCodigo = new QuestaoFechada(null, "bla", "bla bla bla\rble ble ble", 1, 1, null, "");
