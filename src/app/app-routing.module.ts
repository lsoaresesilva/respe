...
const routes: Routes = [
  {path:"main", component:MainComponent, canActivate: [AuthGuard],children: [
    ...
    {path:"meu-desempenho", component:AcompanharDesempenhoComponent, outlet:"principal", canActivate: [AuthGuard, ExperimentoGuard]},
    ...
    {path:"visualizacao-planejamento/:id", component:VisualizarPlanejamentoComponent, canActivate: [AuthGuard, ExperimentoGuard],outlet:"principal"},
    {path:"cadastro-planejamento", component:CadastroPlanejamentoComponent, canActivate: [AuthGuard, ExperimentoGuard], outlet:"principal"},
    {path:"listagem-planejamento", component:ListarPlanejamentosComponent, canActivate: [AuthGuard, ExperimentoGuard], outlet:"principal"},
    {path:"srl-autoreflexao/:id", component:AutoReflexaoComponent, canActivate: [AuthGuard, ExperimentoGuard], outlet:"principal"},
    {path:"cadastro-questao/:assuntoId", component:CadastrarQuestoesComponent, canActivate: [AuthGuard, AdminGuard], canLoad: [AuthGuard, AdminGuard], outlet:"principal"},
    {path:"cadastro-questao/:assuntoId/:questaoId", component:CadastrarQuestoesComponent, canActivate: [AuthGuard, AdminGuard],outlet:"principal"},
    {path:"cadastro-questao-fechada/:assuntoId", component:CadastrarQuestoesFechadasComponent,canActivate: [AuthGuard,AdminGuard],outlet:"principal"},
    {path:"cadastro-questao-fechada/:assuntoId/:questaoId", component:CadastrarQuestoesFechadasComponent,canActivate: [AuthGuard, AdminGuard],outlet:"principal"},
    {path:"atualizacao-questao/:id", component:CadastrarQuestoesComponent, canActivate: [AuthGuard, AdminGuard],outlet:"principal"},
    {path:"atualizacao-planejamento/:id", component:CadastroPlanejamentoComponent, canActivate: [AuthGuard, AdminGuard], outlet:"principal"},
    {path:"cadastro-assunto", component:CadastrarAssuntosComponent, canActivate: [AuthGuard, AdminGuard], canLoad: [AuthGuard,AdminGuard], outlet:"principal"},
    {path:"atualizacao-questao/:assuntoId/:questaoId", component:CadastrarQuestoesComponent, canActivate: [AuthGuard,AdminGuard],outlet:"principal"},
    {path:"atualizacao-questao-fechada/:assuntoId/:questaoId", component:CadastrarQuestoesFechadasComponent, canActivate: [AuthGuard,AdminGuard],outlet:"principal"},
    {path:"atualizacao-assunto/:id", component:CadastrarAssuntosComponent, canActivate: [AuthGuard,AdminGuard], outlet:"principal"},
    {path:"listagem-questoes", component:ListarQuestoesComponent, canActivate: [AuthGuard, AdminGuard],outlet:"principal"},
    {path:"listagem-assuntos", component:ListarAssuntosComponent, canActivate: [AuthGuard],outlet:"principal"},
    ...
    {path:"cadastro-questao-fechada", component:CadastrarQuestoesFechadasComponent, canActivate: [AuthGuard, AdminGuard], outlet:"principal"},
    {path:"visualizacao-questao-fechada/:id", component:VisualizarQuestaoFechadaComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"listagem-questoes-fechadas", component:ListarQuestoesFechadasComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"escolher-questao/:assuntoId", component:EscolherQuestaoComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"visualizar-submissao-questao/:submissaoId", component:VisualizarSubmissaoQuestaoComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"visualizacao-assunto/:id", component:VisualizarAssuntoComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"self-instruction/:assuntoId/:questaoId", component:SelfInstructionComponent, canActivate: [AuthGuard, ExperimentoGuard], outlet:"principal"},
    {path:"estudantes-questao/:assuntoId/:questaoId", component:ListarEstudantesSubmissaoComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"codigo-similar", component:RespostaSimilarQuestaoProgramacaoComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"exibir-codigo/:questaoId", component: ExibirSolucaoComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"visualizacao-turma/:turmaId", component:VisualizarTurmaComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"minha-turma", component:VisualizarTurmaComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"cadastrar-postagem/:turmaId/:postagemId", component:CadastrarPostagemComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"cadastrar-postagem/:turmaId", component:CadastrarPostagemComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"listar-postagens/:turmaId", component:ListarPostagensComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"visualizar-postagem/:postagemId/:turmaId", component:VisualizarPostagemComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"visualizacao-estudante/:id", component:VisualizarPerfilEstudanteComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"envio-material/:turmaId", component:EnvioMaterialComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"listar-materiais/:turmaId", component:ListarMateriaisComponent, canActivate: [AuthGuard], outlet:"principal"},
    {path:"visualizacao-turma/:turmaId", component: VisualizarTurmaComponent, canActivate: [AuthGuard], outlet:"principal"},
