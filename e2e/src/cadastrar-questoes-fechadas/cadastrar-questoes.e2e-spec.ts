...
import { CadastroQuestaoFechadaPage } from './cadastrar-questoes.po';


browser.waitForAngularEnabled(false);

describe('Testes E2E de cadastro de questao de fechada', () => {
  let page:  CadastroQuestaoFechadaPage;
  let firestore: DocumentFirestoreTest;

  beforeAll(() => {

    page = new  CadastroQuestaoFechadaPage();
    page.navigateTo();
  ...
  it('deve efetivar um cadastro de questao', (done) => {
    ...
    firestore.count("questoes").subscribe(contagemAnterior => {
      ...
      page.getButtonCriarAlternativa().click().then
